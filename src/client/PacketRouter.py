    ...
    def __init__(self):
        ...
        self.packets = [
            ...
            Packet(cmd="msz",
                   ...
                   gui=True),
            Packet(cmd="bct",
                   parser=self.zappy.packet_parser.parseGUIMapContentPacket,
                   listeners=[self.zappy.gui.onMapContent],
                   gui=True),
            Packet(cmd="tna",
                   parser=self.zappy.packet_parser.parseGUITeamName,
                   listeners=[self.zappy.gui.onTeamNames],
                   gui=True),
            Packet(cmd="pnw",
            ...
            Packet(cmd="pin",
                   ...
                   gui=True),
            Packet(cmd="pex",
                   parser=self.zappy.packet_parser.parseGUIPlayerName,
